...
const shape_color_input = document.querySelector('input[type=color]')
...
const drawCircle = () => {
  ...
  const shapeColor = shape_color_input.value
...
const drawRectangle = () => {
  ...
  rectangle.setShapeColor = shapeColor
  rectangle.draw(ctx)
}
